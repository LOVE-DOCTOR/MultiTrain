...
# In your code, you can adjust the names of X_train, X_test, y_train and y_test if you named them differently when splitting (line 58 - 60)

class Models:
    
    def __init__(self, lr=0, sgdc=0, pagg=0, rfc=0, gbc=0, cat=0, xgb=0, gnb=0, lda=0, knc=0, mlp=0, svc=0,
                 index=0, highest_acc=0, check_best_model=[]):
        """
